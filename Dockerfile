...
RUN	echo "trap 'tput civis; stty sane' SIGUSR2" >> /etc/bash.bashrc
RUN	echo "trap 'cd; mv sarraila ate_irekia; mv helburua heburu_lortua; clear; tput cnorm' SIGUSR1" >> /etc/bash.bashrc
